...
#	  return (p.x*nx+p.y*ny) >= 0
	...
	def pointinside2(self, p):
		if not self.isinsidebounds(p): return False
...
#	baz = coord3.isinside(poly1)
	foo = poly1.pointinside2(coord1)
	bar = poly1.pointinside2(coord2)
	baz = poly1.pointinside2(coord3)
